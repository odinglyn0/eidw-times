...
const statusConfig: Record<FacilityStatus, {
  ...
  open: {
    ...
    bgColor: "bg-emerald-500/25 dark:bg-emerald-500/30",
  ...
  closed: {
    dotColor: "bg-red-500",
    bgColor: "bg-red-500/25 dark:bg-red-500/30",
    textColor: "text-red-700 dark:text-red-400",
    borderColor: "border-red-500/50 dark:border-red-500/60",
    label: "Closed",
    pingColor: "bg-red-400",
  },
  "opening-soon": {
    dotColor: "bg-amber-500",
    bgColor: "bg-amber-500/25 dark:bg-amber-500/30",
    textColor: "text-amber-700 dark:text-amber-400",
    borderColor: "border-amber-500/50 dark:border-amber-500/60",
    label: "Opening Soon",
    pingColor: "bg-amber-400",
  },
  "closing-soon": {
    dotColor: "bg-orange-500",
    bgColor: "bg-orange-500/25 dark:bg-orange-500/30",
    textColor: "text-orange-700 dark:text-orange-400",
    borderColor: "border-orange-500/50 dark:border-orange-500/60",
    label: "Closing Soon",
